...
export default function RootLayout({children}: Readonly<{
...
}>)
	{
		return (
				<html
						lang="vi"
						className={`${roboto.className} ${poppins.className} h-full antialiased`}
				>
				...
				<Script src="../styles/bootstrap/js/bootstrap.min.js" strategy="lazyOnload"/>
				...
				<Script src="/assets/js/jquery.dd.min.js" strategy="lazyOnload"/>
				<Script src="/assets/js/slick.min.js" strategy="lazyOnload"/>
				<Script src="/assets/js/jquery.elevatezoom.js" strategy="lazyOnload"/>
