							...
							<div className="row">
								<div className="col-md-6">
									<div className="single_banner">
										<Image src="/assets/images/shop_banner_img1.jpg"
										...
										<div className="single_banner_info">
											...
											<h3 className="single_bn_title">
												New Collection
											</h3>
											<a href="" className="single_bn_link">Shop Now</a>
										</div>
									</div>
								</div>
								<div className="col-md-6">
									<div className="single_banner">
										<Image src="/assets/images/shop_banner_img2.jpg"
